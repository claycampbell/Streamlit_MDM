...
class Snowflakeconnection:
    ...
    def show_columns(self, connection):
        # Assuming 'connection' is an active Snowflake connection passed to this function
        try:
            ...
            for row in columns_info:
                # Unpack the row
                table_name, schema_name, column_name, column_type, is_nullable, default_value, kind, expression, comment, database_name, autoincrement = row
                # Print the desired columns
                print(f'{column_name}|{table_name}|{column_type}')
